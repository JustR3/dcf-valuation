...
class DCFEngine:
    ...
    @property
    def company_data(self) -> CompanyData | None:
    ...
    def _get_ticker_cashflow(self, ticker: str) -> pd.DataFrame | None:
    ...
    def calculate_dcf(self, fcf0: float, growth: float, term_growth: float,
                      ...
                      exit_multiple: float | None = None) -> tuple[list[dict], float, float, float, dict]:
    ...
    def _get_hardcoded_benchmark(self, sector: str) -> float | None:
    ...
    def get_sector_exit_multiple(self, sector: str | None = None) -> float:
    ...
    def run_scenario_analysis(self, base_growth: float | None = None,
                               ...
                               base_wacc: float | None = None, years: int = 5) -> dict:
    ...
    def run_sensitivity_analysis(self, base_growth: float | None = None,
                                  base_term_growth: float = 0.025,
                                  base_wacc: float | None = None, years: int = 5) -> dict:
